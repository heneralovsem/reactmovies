    ...
    <div className={cl.item__wrapper}>
      <div className={cl.item__details__wrapper}>
        ...
        <div className={cl.item__info}>
          ...
          <p>{props.type}</p>
          <div className={cl.item__rating__wrapper}>
            <Button
              className={cl.item__rating__button}
              size="small"
              variant="outlined"
              onClick={openModal}
            >
            ...
            <Icon size={1} className={cl.item__icon} path={mdiStar}></Icon>
            {props.rating > 0 ? (
              <span className={cl.item__rating}>{props.rating}</span>
            ) : (
              <span className={cl.item__rating}>N/A</span>
            )}
          </div>
